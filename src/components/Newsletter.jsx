...
<form className="flex items-center justify-between max-w-2xl w-full md:h-13 h-12 ">
    ...
    <button type="submit" className="bg-primary/80 text-white md:px-12 px-8 h-full rounded-md hover:bg-primary transition-all cursor-pointer rounded-md rounded-l-none">Subscribe</button>
</form>
        </div> 
